...
@endif
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>{{ session()->get('success_archive') }}</strong>
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>
                                ...
                                <table id="example1" class="table key-buttons text-md-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('showDetails',$invoice->id) }}">{{ $invoice->section->section_name }}</a>
                                            </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form action="{{ route('destroy_arc') }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
            </div>
            ...
            <div class="modal fade" id="Transfer_invoice" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            هل انت متاكد من عملية الغاءالارشفة ؟
                            <input type="hidden" name="invoice_id" id="invoice_id" value="">
